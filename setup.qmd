...
The preprocessed data can be downloaded **[here](https://ln5.sync.com/dl/88a6f5dd0#u24mrtkh-d5dqhart-zrg42shx-jfhhk8u5)**. Ensure the data is stored in the same folder where your code is stored.
...
After downloading the data and setting up the python environment (see above), your directory structure should include the following (among other miscelaneous files):
