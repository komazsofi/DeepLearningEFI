...
A common point-based deep learning technique is **set abstraction**, used in models such as PointNet++ <a href="https://dl.acm.org/doi/10.5555/3295222.3295263" target="_blank">(Qi et al., 2017)</a>. Instead of sliding filters over a grid like a CNN, set abstraction groups nearby points in the point cloud to capture local geometric patterns. Each layer selects representative points, gathers their neighbours, and learns features from these local groups. As the data moves through successive layers, the model captures increasingly complex 3D structures from fine details to larger objects such as trees and forest canopies.

![Set Abstraction (adapted from Qi et al., (2017))](images/setabstraction.png){#fig-set-abstraction fig-align="center"}
...
![Point cloud augmentations](images/augmentations.png){#fig-augmentations fig-align="center" width=80%}
