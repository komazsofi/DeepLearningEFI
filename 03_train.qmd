...
This section covers the implementation of the `DGCNN` model, including its structure of feature extraction layers and final classification/regression heads.
...
<div id="wandb-container" style="width:100%; height:600px; border:1px solid #ddd; display:flex; justify-content:center; align-items:center; background:#f9f9f9;">
  <button onclick="loadWandb()" style="padding:15px 30px; font-size:16px; cursor:pointer; background:#111; color:#fff; border-radius:5px;">
...
<script>
function loadWandb() {
  const container = document.getElementById('wandb-container');
  container.innerHTML = `<iframe src="https://api.wandb.ai/links/ubc-yuwei-cao/akty7srj" style="border:none;height:600px;width:100%" loading="lazy"></iframe>`;
}
</script>
...
function loadWandb() {
  const container = document.getElementById('wandb-container');
  container.innerHTML = `<iframe src="https://api.wandb.ai/links/ubc-yuwei-cao/qs96lr1s" style="border:none;height:600px;width:100%" loading="lazy"></iframe>`;
}
</script>
