...
::: {#fig-dl_frames-graph}
![Deep learning fromeworks](https://static.packt-cdn.com/products/9781800561618/graphics/image/B16692_01_02.jpg){width=60%}
...
![Pytorch Lightning Components](./images/03_train/pl_modules.png)
...
- **Metrics**, e.g., R² Score (biomass regression), overall accuracy and mean per-calss accuracy (tree species classification)
...
![Example](images\03_train\training_screenshot.png){width=70%}
