...
The first step in any deep learning project is getting your data from files on disk into **tensors** on the GPU. 


In this project, that job is handled by two Python scripts:
...
Tensors are the fundamental building block of deep learning. Their job is to represent data in a numerical way. An n-dimensional array of numbers, a 0-dimension tensor is a scalar, a 1-dimension tensor is a vector
:::
...
![](./images/03_train/ChatGPT_pc_tensor.png){width="70%"}

`EfiDataset` workflow (Generated by ChatGPT)
...
::: {#fig-datamodule-graph}

![](./images/03_train/ChatGPT_datamodule.png){width="70%"}

`EfiDataModule` workflow (Generated by ChatGPT)
