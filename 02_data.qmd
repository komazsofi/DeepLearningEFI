...
::: callout-note
Expert knowledge is critical when preparing data for deep leanring workflows since small artifacts or errors in the data can have large impacts on downstream model performance.
:::
...
1) Sample plot point cloud stored as numpy array files (.npy) in `data/petawawa/plot_point_clouds`
