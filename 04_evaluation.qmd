...
OBS_PRED_FPATH = r'src/pretrained_ckpt/peta_reg_ocnn_bs16_lre4_ckpt_ocnn_nbk_idXM6D/checkpoints/predictions.csv'
...
## Random Forest
For comparison, we can compare the DNN results with those obtained by training random forest (RF) model.
