...
# Load predictions
test_df = pd.read_csv("src\pretrained_ckpt\peta_cls_dgcnn_bs16_lre4\checkpoints\predictions.csv")
...
function loadWandb() {
  ...
  container.innerHTML = `<iframe src="https://api.wandb.ai/links/ubc-yuwei-cao/q2oxsdbc" style="border:none;height:600px;width:100%" loading="lazy"></iframe>`;
}
</script>
