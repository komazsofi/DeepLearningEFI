...
In the figure above we can see some point cloud samples from out testing set that have been classified correctly (top row) and some examples that have been misclassified (bottom row). Visualizing these outputs helps the user to understand the where the errors have occurred and maybe why they have occurred as well based on their domain knowledge.
