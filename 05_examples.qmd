...
1. Selecting polygons from the “Cleaned FRI” overlapping each $128 \times 128$-pixel tile (red-bounded region).
2. Grouping all pixels fully contained within a given polygon into a single superpixel, and assigning its identifier (“POLYID”) from the corresponding overlapped polygon.
3. Marking pixels intersecting polygon boundaries or outside any polygon as “no data”.
...
![Multi-Stream Fusion Model](images\05_examples_TSC\architecture-m3f.jpg){#fig-fusion-model fig-align="center" width=60%}
